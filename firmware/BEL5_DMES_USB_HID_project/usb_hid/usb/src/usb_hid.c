...
#include "../../../usb_hid/usb/inc/app_usbd_cfg.h"
#include "../../../usb_hid/usb/inc/hid_generic.h"
/*********************************************************************DEFINES*/
/*********************************************************************GLOBALS-STATIC*/
...
int usb_config_hid_device(void) {
	...
	/*	WORKAROUND for artf44835 ROM driver BUG:
	    ...
	    to avoid data corruption. Corruption of padding memory does not affect the
...
//void my_usb_hid_transmit(uint8_t *data_ptr)
//{}
